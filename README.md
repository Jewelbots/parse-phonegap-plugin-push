...
```
phonegap plugin add phonegap-plugin-push-parse
```
or 

```
cordova plugin add phonegap-plugin-push-parse
```

It is also possible to install via repo url directly ( unstable )

```
phonegap plugin add https://github.com/Jewelbots/phonegap-plugin-push-parse
```

or 

```
cordova plugin add https://github.com/Jewelbots/phonegap-plugin-push-parse
```
